...
{
    public class ListarFavoritosRequest
    {
        [Required(ErrorMessage = "Codigo do usuario deve ser informado.")]
        [Range(1, int.MaxValue, ErrorMessage = "Codigo do usuario deve ser maior que zero.")]
